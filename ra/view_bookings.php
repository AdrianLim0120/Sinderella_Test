...
$services_query = "SELECT service_id, service_name FROM services WHERE service_status = 'active'";
...
$query = "SELECT b.booking_id, b.booking_date, b.booking_from_time, b.booking_to_time, 
            c.cust_name, s.sind_name, sv.service_name, b.booking_status, b.full_address, b.booking_type
          FROM bookings b
...
if ($search_service) {
    $query .= " AND sv.service_id = '" . $conn->real_escape_string($search_service) . "'";
}
